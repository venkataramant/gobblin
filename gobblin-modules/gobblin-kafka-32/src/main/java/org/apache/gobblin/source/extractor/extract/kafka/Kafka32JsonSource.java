 ...
 */
public class Kafka32JsonSource extends KafkaSource<JsonArray, JsonObject> {
  @Override
  public List<WorkUnit> getWorkunits(SourceState state) {
    if (!state.contains(Kafka32ConsumerClient.GOBBLIN_CONFIG_VALUE_DESERIALIZER_CLASS_KEY)) {
      state.setProp(Kafka32ConsumerClient.GOBBLIN_CONFIG_VALUE_DESERIALIZER_CLASS_KEY,
