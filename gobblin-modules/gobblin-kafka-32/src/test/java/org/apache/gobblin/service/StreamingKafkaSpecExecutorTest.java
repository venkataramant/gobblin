...
public class StreamingKafkaSpecExecutorTest extends KafkaTestBase {
  ...
  public void testAddSpec() throws Exception {
    ...
    _properties.setProperty("spec.kafka.dataWriterClass", "org.apache.gobblin.kafka.writer.Kafka32DataWriter");
    ...
    _properties.setProperty(KafkaJobMonitor.KAFKA_JOB_MONITOR_PREFIX + "." + Kafka32ConsumerClient.GOBBLIN_CONFIG_VALUE_DESERIALIZER_CLASS_KEY, "org.apache.kafka.common.serialization.ByteArrayDeserializer");
    ...
    _properties.setProperty(KafkaJobMonitor.KAFKA_JOB_MONITOR_PREFIX + "." + Kafka32ConsumerClient.CONFIG_PREFIX + Kafka32ConsumerClient.CONSUMER_CONFIG + ".auto.offset.reset", "earliest");
