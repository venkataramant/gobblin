...
import org.apache.gobblin.kafka.writer.Kafka32JsonObjectWriterBuilder;
import org.apache.gobblin.runtime.util.MultiWorkUnitUnpackingIterator;
import org.apache.gobblin.source.extractor.DataRecordException;
import org.apache.gobblin.source.extractor.Extractor;
import org.apache.gobblin.source.extractor.extract.kafka.Kafka32JsonSource;
...
/**
 * An integration test for {@link Kafka32JsonSource} and {@link Kafka32JsonObjectWriterBuilder}. The test writes
 * a json object to kafka with the writer and extracts it with the source
 */
@Slf4j
public class Kafka32JsonIntegrationTest {
  private final Gson gson;
  private final KafkaTestBase kafkaTestHelper;

  public Kafka32JsonIntegrationTest()
  ...
  private SourceState createSourceState(String topic) {
    ...
    state.setProp(KafkaSource.GOBBLIN_KAFKA_CONSUMER_CLIENT_FACTORY_CLASS,
        Kafka32ConsumerClient.Factory.class.getName());
  ...
  public void testHappyPath()
    ...
    String topic = "testKafka32JsonSource";
    ...
    Kafka32JsonObjectWriterBuilder writerBuilder = new Kafka32JsonObjectWriterBuilder();
    ...
    Kafka32JsonSource source = new Kafka32JsonSource();
    List<WorkUnit> workUnitList = source.getWorkunits(state);
    // Test the right value serializer is set
    Assert.assertEquals(state.getProp(Kafka32ConsumerClient.GOBBLIN_CONFIG_VALUE_DESERIALIZER_CLASS_KEY),
        Kafka32JsonSource.KafkaGsonDeserializer.class.getName());
