...
import org.apache.gobblin.kafka.writer.Kafka32DataWriter;
...
public class HighLevelConsumerTest extends KafkaTestBase {
  ...
  public void beforeSuite()
    ...
    producerProps.setProperty(KafkaWriterConfigurationKeys.BOOTSTRAP_SERVERS_KEY, this.getBootstrapServersString());
    ...
    AsyncDataWriter<byte[]> dataWriter = _closer.register(new Kafka32DataWriter<byte[], byte[]>(producerProps));
  ...
  public static Config getSimpleConfig(Optional<String> prefix) {
    ...
    properties.put(getConfigKey(prefix, Kafka32ConsumerClient.GOBBLIN_CONFIG_VALUE_DESERIALIZER_CLASS_KEY), Kafka32ConsumerClient.DEFAULT_KEY_DESERIALIZER);
  ...
  public void testConsumerAutoOffsetCommit() throws Exception {
    ...
    consumerProps.setProperty(Kafka32ConsumerClient.GOBBLIN_CONFIG_VALUE_DESERIALIZER_CLASS_KEY, "org.apache.kafka.common.serialization.ByteArrayDeserializer");
