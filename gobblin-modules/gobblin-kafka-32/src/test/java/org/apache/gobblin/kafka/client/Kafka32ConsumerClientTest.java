...
import org.apache.gobblin.kafka.client.Kafka32ConsumerClient.Kafka32ConsumerRecord;


public class Kafka32ConsumerClientTest {
  ...
  public void testConsume() throws Exception {
    ...
    try (Kafka32ConsumerClient<String, String> kafka32Client = new Kafka32ConsumerClient<>(testConfig, consumer);) {

      // Consume from 0 offset
      Set<KafkaConsumerRecord> consumedRecords =
          Sets.newHashSet(kafka32Client.consume(new KafkaPartition.Builder().withId(0).withTopicName("test_topic")
              .build(), 0l, 100l));

      Set<Kafka32ConsumerRecord<String, String>> expected =
          ImmutableSet.<Kafka32ConsumerRecord<String, String>> of(new Kafka32ConsumerRecord<>(record0),
              new Kafka32ConsumerRecord<>(record1), new Kafka32ConsumerRecord<>(record2));
