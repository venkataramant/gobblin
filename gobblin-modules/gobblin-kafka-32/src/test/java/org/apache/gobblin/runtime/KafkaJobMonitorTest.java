...
public class KafkaJobMonitorTest extends KafkaTestBase {
  ...
  public void beforeSuite() throws Exception {
    ...
    dataWriter = _closer.register(new Kafka32DataWriter(producerProps));
  }
  ...
  public void test() throws Exception {
    ...
    consumerProps.put(KafkaJobMonitor.KAFKA_JOB_MONITOR_PREFIX + "." + Kafka32ConsumerClient.GOBBLIN_CONFIG_VALUE_DESERIALIZER_CLASS_KEY, "org.apache.kafka.common.serialization.ByteArrayDeserializer");
